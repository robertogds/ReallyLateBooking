...
public final class ImageHelper {
	...
	public static void prepareImagesRoutes(DealDTO deal){
		...
		deal.listImage = deal.listImage != null && !deal.listImage.isEmpty() ? imgDirUrl + concatImageSize(deal.listImage, listSizeV2) : null;
