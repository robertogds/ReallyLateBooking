...
(function() {
  ...
  root.indexWindow = new root.GenericWindow(L('index')).win;
  ...
  root.win = Titanium.UI.createWindow({
    backgroundColor: '#fec52c',
    title: 'FirstWindow'
  });

  root.nav = Titanium.UI.MobileWeb.createNavigationGroup({
    window: root.indexWindow
  });

  root.win.add(root.nav);
