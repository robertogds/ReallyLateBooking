...
(function() {
  ...
  Ti.include('/js/faqView.js', '/js/facebookButton.js', '/js/editAccountView.js', '/js/newAccountView.js', '/js/loginAction.js', '/js/logoutAction.js', '/js/newFacebookAccount.js', '/js/rememberPassView.js', '/js/signInView.js', '/js/rememberPassAction.js');
  ...
  root.registerLabelView.label1.addEventListener('click', function(e) {
    if (root.isLogged()) {
      ...
      return root.confirmLogout.show();
    } else {
